...
public class LocalSlopeFinderG {
   ...
   */
  public LocalSlopeFinderG(double sigma1, double pmax) {
   ...
   *  The minimum slope will be the negative of this maximum.
   */
  public LocalSlopeFinderG(double sigma1, double sigma2, double pmax) {
  ...
  public void findSlopes(float[][] f, float[][] p2, float[][] el) {
    ...
    float[][] u2 = p2;
    LocalOrientFilterG lof = new LocalOrientFilterG(_sigma1,_sigma2);
 ...
 /**
   ...
   * @param el if not null, array[n2][n1] of output linearities.
   */
  public void findSlopes_normal(float[][] f, float[][] p2, float[][] el, float[][] u11, float[][] u12) {
    int n1 = f[0].length;
    int n2 = f.length;
...
//     u12 = u2;
  ...
  public void findSlopes(
    ...
    float[][][] u2 = p2;
    float[][][] u3 = p3;
    LocalOrientFilterG lof = new LocalOrientFilterG(_sigma1,_sigma2,_sigma3);
